...
parser.add_argument("--pred", type=str,default='/home/vim/SR_GAN/SRGAN_0/prediction', help=".xyz")
parser.add_argument("--gt", type=str, default='/home/vim/SR_GAN/SRGAN_0/ground_truth', help=".xyz")
